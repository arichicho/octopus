  ...
  return (
    <header className="sticky top-0 z-40 bg-white/80 dark:bg-gray-900/80 backdrop-blur supports-[backdrop-filter]:bg-white/60 supports-[backdrop-filter]:dark:bg-gray-900/60 border-b border-gray-200/60 dark:border-gray-800">
      <div className="mx-auto max-w-6xl px-4 py-3 flex items-center gap-3">
        ...
        <div className="flex-1">
          <div className="relative">
            <input
              ...
              className="w-full h-10 rounded-full bg-gray-100 dark:bg-gray-800 px-10 text-sm outline-none focus:ring-2 focus:ring-blue-500/40 transition-all"
            />
        ...
        {/* Date pill */}
        <div className="hidden sm:flex items-center text-sm text-gray-600 dark:text-gray-300 px-3 py-1.5 rounded-full bg-gray-100 dark:bg-gray-800">
        ...
        <button
          onClick={onQuickAdd}
          className="hidden sm:inline-flex items-center gap-2 px-3 h-9 rounded-full bg-blue-600 text-white hover:bg-blue-700 transition-colors"
        >
          ＋ Nueva tarea
        </button>
        ...
        <div className="relative">
          <button
            ...
            className="w-9 h-9 rounded-full bg-gray-200 dark:bg-gray-700 overflow-hidden hover:bg-gray-300 dark:hover:bg-gray-600 transition-colors"
          >
            {user?.photoURL ? (
              <img 
                src={user.photoURL} 
          ...
          {showUserMenu && (
            <div className="absolute right-0 top-full mt-2 w-48 bg-white dark:bg-gray-800 rounded-lg shadow-lg border border-gray-200 dark:border-gray-700 py-1 z-50">
              ...
              <button className="w-full px-3 py-2 text-left text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 flex items-center gap-2">
